...
class __TwigTemplate_3b74c28c1dbcf29db79c6f7ebe840d42328f88b6bd8a88e9043aa0d1938c0fe9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <p> ";
            // line 6
            echo twig_escape_filter($this->env, twig_truncate_filter($this->env, twig_get_attribute($this->env, $this->source, $context["project"], "description", [], "any", false, false, false, 6), (isset($context["default_truncate_limit"]) || array_key_exists("default_truncate_limit", $context) ? $context["default_truncate_limit"] : (function () { throw new RuntimeError('Variable "default_truncate_limit" does not exist.', 6, $this->source); })())), "html", null, true);
            echo " </p>
        <ul>
...
{%  for project in projects %}
    <article>
        <h2> {{ project.name }} </h2>
        <p> {{ project.description|truncate(default_truncate_limit) }} </p>
        <ul>
